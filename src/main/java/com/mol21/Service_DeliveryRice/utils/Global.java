package com.mol21.Service_DeliveryRice.utils;
...
public class Global {
    ...
    public static final String TIPO_EX = "exception";
    public static final String TIPO_EX_VALID = "valid-exception";
    public static final String TIPO_EX_SQL = "sql-exception";
